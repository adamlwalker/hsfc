...
Question.where(id: 133, position: 22,   input_type: "text",      admin_only_question: TRUE, parent_id: 1180, content: "Name(s)").first_or_create!
Question.where(id: 134, position: 23,   input_type: "integer",   admin_only_question: TRUE, parent_id: 1180, content: "Age").first_or_create!
Question.where(id: 135).first_or_create!(position: 24,   input_type: "select", admin_only_question: TRUE, parent_id: 1180, option_list: "{Female, Male}", content: "Sex")
Question.where(id: 136, position: 25,   input_type: "radio",     admin_only_question: TRUE, parent_id: 1180, content: "Spayed or Neutered").first_or_create!
Question.where(id: 137, position: 26,   input_type: "text",      admin_only_question: TRUE, parent_id: 1180, content: "Description").first_or_create!
Question.where(id: 138, position: 27,   input_type: "text",      admin_only_question: TRUE, parent_id: 1180, content: "Medical history").first_or_create!
Question.where(id: 139, position: 28,   input_type: "text",      admin_only_question: TRUE, parent_id: 1180, content: "Medical work pending").first_or_create!
Question.where(id: 140, position: 29,   input_type: "text",      admin_only_question: TRUE, parent_id: 1180, content: "Other information").first_or_create!
...
Question.where(id: 13,  position: 150,  input_type: "none",      admin_only_question: FALSE, parent_id: 140, content: "PET").first_or_create!
Question.where(id: 14,  position: 160,  input_type: "text",      admin_only_question: FALSE, parent_id: 150, content: "Breed").first_or_create!
Question.where(id: 15,  position: 170,  input_type: "text",      admin_only_question: FALSE, parent_id: 150, content: "Name").first_or_create!
Question.where(id: 16,  position: 180,  input_type: "integer",   admin_only_question: FALSE, parent_id: 150, content: "Age").first_or_create!
Question.where(id: 17).first_or_create!(position: 190,  input_type: "select",    admin_only_question: FALSE, option_list: "{Female, Male}", parent_id: 150, content: "Sex")
Question.where(id: 18,  position: 200,  input_type: "text",      admin_only_question: FALSE, parent_id: 150, content: "Where was/is it housed?").first_or_create!
...
Question.where(id: 22,  position: 220,  input_type: "textarea",  admin_only_question: FALSE, parent_id: 210, content: "If so, describe your horse").first_or_create!
Question.where(id: 23,  position: 230,  input_type: "radio",     admin_only_question: FALSE, parent_id: 210, content: "If so, is it spayed or Neutered?").first_or_create!
Question.where(id: 24,  position: 240,  input_type: "radio",     admin_only_question: FALSE, parent_id: 210, content: "If so, is it properly licensed?").first_or_create!
Question.where(id: 25,  position: 250,  input_type: "radio",     admin_only_question: FALSE, parent_id: 210, content: "If so, was it vaccinated this year?").first_or_create!
Question.where(id: 26,  position: 260,  input_type: "integer",   admin_only_question: FALSE, parent_id: 210, content: "If not, how many years did you own that animal? (Round down to the nearest year.)").first_or_create!
Question.where(id: 27,  position: 210,  input_type: "radio",     admin_only_question: FALSE, parent_id: 150, content: "Do you still own the animal?").first_or_create!
Question.where(id: 28,  position: 270,  input_type: "textarea",  admin_only_question: FALSE, parent_id: 210, content: "If not, what happened to the animal?").first_or_create!
...
Question.where(id: 30,  position: 290,  input_type: "textarea",  admin_only_question: FALSE, parent_id: 280, content: "If so, Vet's name").first_or_create!
Question.where(id: 31,  position: 300,  input_type: "textarea",  admin_only_question: FALSE, parent_id: 280, content: "If so, Veterinary clinic/hospital phone number").first_or_create!
Question.where(id: 32,  position: 310,  input_type: "textarea",  admin_only_question: FALSE, parent_id: 280, content: "If so, Veterinary clinic/hospital address").first_or_create!
Question.where(id: 33,  position: 320,  input_type: "radio",     admin_only_question: FALSE, parent_id: 280, content: "If so, may we have your permission to contact them?").first_or_create!
Question.where(id: 34,  position: 330,  input_type: "none",      admin_only_question: FALSE, parent_id: 280, content: "If so, PLEASE INFORM YOUR VET THAT HSFC WILL CONTACT THEM TO VERIFY YOU PET'S TREATMENT RECORDS").first_or_create!
...
Question.where(id: 142, position: 1280, input_type: "radio",     admin_only_question: TRUE, parent_id: 1270, content: "Are the medical records current for all their pets?").first_or_create!
Question.where(id: 143, position: 1290, input_type: "text",      admin_only_question: TRUE, parent_id: 1270, content: "Comments from discussion with Veterinarian").first_or_create!
Question.where(id: 144, position: 1300, input_type: "date",      admin_only_question: TRUE, parent_id: 1270, content: "Date health check completed").first_or_create!
...
Question.where(id: 36).first_or_create!(position: 350,  input_type: "select",    admin_only_question: FALSE, option_list: "{House, Apartment, Condo, Townhouse, Duplex}", content: "Living arrangement")
Question.where(id: 37,  position: 360,  input_type: "textarea",  admin_only_question: FALSE, parent_id: 350, content: "If you have an enclosed fence, please list type and height.").first_or_create!
Question.where(id: 38).first_or_create!(position: 370,  input_type: "select",    admin_only_question: FALSE, option_list: "{Own, Rent}", parent_id: 350, content: "Do you (or your parents/roomates) own or rent your home?")
Question.where(id: 39,  position: 380,  input_type: "textarea",  admin_only_question: FALSE, parent_id: 350, content: "Please detail any restrictions on pets, such as weight, type or number of pets.").first_or_create!
Question.where(id: 40,  position: 390,  input_type: "textarea",  admin_only_question: FALSE, parent_id: 350, content: "Name of Development, Apartment or Condo Complex, if applicable").first_or_create!
Question.where(id: 41,  position: 400,  input_type: "textarea",  admin_only_question: FALSE, parent_id: 350, content: "Landlord/HOA/Manager’s Name (if applicable)").first_or_create!
Question.where(id: 42,  position: 410,  input_type: "textarea",  admin_only_question: FALSE, parent_id: 350, content: "Landlord/HOA/Manager’s Phone # (if applicable)").first_or_create!
Question.where(id: 43,  position: 420,  input_type: "radio",     admin_only_question: FALSE, parent_id: 350, content: "May we have your permission to call your Development, Apartment or Condo Complex?  (if applicable)").first_or_create!
Question.where(id: 44,  position: 430,  input_type: "none",      admin_only_question: FALSE, parent_id: 350, content: "PLEASE INFORM YOUR LANDLORD/HOA/MANAGER THAT HSFC WILL CONTACT THEM TO DISCUSS ANY BREED OR SIZE RESTRICTIONS THEY HAVE FOR PETS.").first_or_create!
Question.where(id: 45,  position: 440,  input_type: "integer",   admin_only_question: FALSE, parent_id: 350, content: "How many adults live in your home? ").first_or_create!
...
Question.where(id: 47,  position: 450,  input_type: "integer",   admin_only_question: FALSE, parent_id: 350, content: "How many children live in your home? ").first_or_create!
Question.where(id: 48,  position: 460,  input_type: "textarea",  admin_only_question: FALSE, parent_id: 450, content: "If there are any children, what are their ages?").first_or_create!
Question.where(id: 49,  position: 470,  input_type: "radio",     admin_only_question: FALSE, parent_id: 350, content: "Is anyone home during the day?").first_or_create!
Question.where(id: 50,  position: 480,  input_type: "radio",     admin_only_question: FALSE, parent_id: 350, content: "Is anyone home during the night?").first_or_create!
Question.where(id: 51,  position: 490,  input_type: "textarea",  admin_only_question: FALSE, parent_id: 350, content: "Are there any other details you'd like to share about your living arrangement?").first_or_create!
Question.where(id: 145, position: 491,  input_type: "none",      admin_only_question: TRUE, content: "Home check").first_or_create!
Question.where(id: 146, position: 492,  input_type: "text",      admin_only_question: TRUE, parent_id: 1310, content: "Applicant’s driver's license number and state of licensure").first_or_create!
Question.where(id: 147, position: 493,  input_type: "text",      admin_only_question: TRUE, parent_id: 1310, content: "Landlord/apartment approval (name of person and date spoken with)").first_or_create!
Question.where(id: 148, position: 494,  input_type: "text",      admin_only_question: TRUE, parent_id: 1310, content: "Name and initials of who completed the home check").first_or_create!
Question.where(id: 149, position: 495,  input_type: "date",      admin_only_question: TRUE, parent_id: 1310, content: "Date home check was completed").first_or_create!
Question.where(id: 150, position: 496,  input_type: "text",      admin_only_question: TRUE, parent_id: 1310, content: "Name and initials of who completed the home check").first_or_create!
...
Question.where(id: 53,  position: 510,  input_type: "textarea",  admin_only_question: FALSE, parent_id: 500, content: "Name").first_or_create!
Question.where(id: 54,  position: 520,  input_type: "textarea",  admin_only_question: FALSE, parent_id: 500, content: "Address").first_or_create!
Question.where(id: 55,  position: 530,  input_type: "textarea",  admin_only_question: FALSE, parent_id: 500, content: "Phone Number").first_or_create!
...
Question.where(id: 57,  position: 550,  input_type: "textarea",  admin_only_question: FALSE, parent_id: 540, content: "Please explain.").first_or_create!
...
Question.where(id: 59,  position: 570,  input_type: "textarea",  admin_only_question: FALSE, parent_id: 560, content: "Please explain.").first_or_create!
...
Question.where(id: 61,  position: 590,  input_type: "textarea",  admin_only_question: FALSE, parent_id: 580, content: "Please explain.").first_or_create!
...
Question.where(id: 65,  position: 610,  input_type: "textarea",  admin_only_question: FALSE, parent_id: 600, content: "Please explain.").first_or_create!
...
Question.where(id: 67,  position: 630,  input_type: "textarea",  admin_only_question: FALSE, parent_id: 620, content: "If so, why?").first_or_create!
...
Question.where(id: 69,  position: 650,  input_type: "textarea",  admin_only_question: FALSE, parent_id: 640, content: "If so, why?").first_or_create!
...
Question.where(id: 87,  position: 820,  input_type: "textarea",  admin_only_question: FALSE, parent_id: 810, content: "How would you handle these behaviors?").first_or_create!
...
Question.where(id: 89,  position: 840,  input_type: "textarea",  admin_only_question: FALSE, parent_id: 830, content: "If so, why?").first_or_create!
...
Question.where(id: 94,  position: 870,  input_type: "radio",     admin_only_question: FALSE, parent_id: 860, content: "House Training 112&113 should be combined").first_or_create!
Question.where(id: 95,  position: 880,  input_type: "radio",     admin_only_question: FALSE, parent_id: 860, content: "Litter").first_or_create!
Question.where(id: 96,  position: 890,  input_type: "radio",     admin_only_question: FALSE, parent_id: 860, content: "Heartworm prevention").first_or_create!
Question.where(id: 97,  position: 900,  input_type: "radio",     admin_only_question: FALSE, parent_id: 860, content: "Obedience").first_or_create!
Question.where(id: 98,  position: 910,  input_type: "radio",     admin_only_question: FALSE, parent_id: 860, content: "Behavioral problems").first_or_create!
Question.where(id: 99,  position: 905,  input_type: "radio",     admin_only_question: FALSE, content: "Scratching/Declawing").first_or_create!
Question.where(id: 100, position: 920,  input_type: "radio",     admin_only_question: FALSE, parent_id: 860, content: "Feeding ").first_or_create!
Question.where(id: 101, position: 922,  input_type: "radio",     admin_only_question: FALSE, content: "Upper Respiratory Infections").first_or_create!
Question.where(id: 102, position: 924,  input_type: "radio",     admin_only_question: FALSE, content: "Feline Leukemia").first_or_create!
Question.where(id: 103, position: 926,  input_type: "radio",     admin_only_question: FALSE, content: "Feline Aids").first_or_create!
Question.where(id: 104, position: 928,  input_type: "radio",     admin_only_question: FALSE, content: "Urinary Problems").first_or_create!
Question.where(id: 105, position: 930,  input_type: "radio",     admin_only_question: FALSE, parent_id: 860, content: "Introducing new pets to pets at home").first_or_create!
Question.where(id: 106, position: 940,  input_type: "radio",     admin_only_question: FALSE, parent_id: 860, content: "Grooming ").first_or_create!
Question.where(id: 107, position: 945,  input_type: "radio",     admin_only_question: FALSE, content: "Flees").first_or_create!
Question.where(id: 108, position: 950,  input_type: "radio",     admin_only_question: FALSE, parent_id: 860, content: "Household dangers").first_or_create!
Question.where(id: 109, position: 960,  input_type: "textarea",  admin_only_question: FALSE, parent_id: 860, content: "Other (please describe)").first_or_create!
Question.where(id: 110, position: 970,  input_type: "none",      admin_only_question: FALSE, content: "Please check the type of pet you're looking for.").first_or_create!
Question.where(id: 111, position: 980,  input_type: "radio",     admin_only_question: FALSE, content: "Adult animal").first_or_create!
Question.where(id: 112, position: 990,  input_type: "radio",     admin_only_question: FALSE, content: "Young animal").first_or_create!
Question.where(id: 113, position: 1000, input_type: "radio",     admin_only_question: FALSE, content: "Companion for another pet").first_or_create!
Question.where(id: 114, position: 1010, input_type: "radio",     admin_only_question: FALSE, content: "Two new, compatible pets").first_or_create!
Question.where(id: 115, position: 1020, input_type: "radio",     admin_only_question: FALSE, content: "Particular breed").first_or_create!
Question.where(id: 116, position: 1030, input_type: "radio",     admin_only_question: FALSE, content: "Children’s pet").first_or_create!
Question.where(id: 117, position: 1040, input_type: "radio",     admin_only_question: FALSE, content: "Short hair").first_or_create!
Question.where(id: 118, position: 1050, input_type: "radio",     admin_only_question: FALSE, content: "Long hair").first_or_create!
Question.where(id: 119, position: 1060, input_type: "radio",     admin_only_question: FALSE, content: "Affectionate lap animal").first_or_create!
Question.where(id: 120, position: 1062, input_type: "radio",     admin_only_question: FALSE, content: "Affectionate animal").first_or_create!
Question.where(id: 121, position: 1064, input_type: "radio",     admin_only_question: FALSE, content: "Inside Cat").first_or_create!
Question.where(id: 122, position: 1068, input_type: "radio",     admin_only_question: FALSE, content: "Outside Cat").first_or_create!
Question.where(id: 123, position: 1066, input_type: "radio",     admin_only_question: FALSE, content: "Declawed Cat").first_or_create!
...
FormTypeQuestion.where(question_id: 94,  form_type_id: 2).first_or_create!
FormTypeQuestion.where(question_id: 95,  form_type_id: 2).first_or_create!
FormTypeQuestion.where(question_id: 95,  form_type_id: 5).first_or_create!
FormTypeQuestion.where(question_id: 95,  form_type_id: 4).first_or_create!
FormTypeQuestion.where(question_id: 96,  form_type_id: 2).first_or_create!
FormTypeQuestion.where(question_id: 97,  form_type_id: 6).first_or_create!
FormTypeQuestion.where(question_id: 97,  form_type_id: 1).first_or_create!
FormTypeQuestion.where(question_id: 98,  form_type_id: 1).first_or_create!
FormTypeQuestion.where(question_id: 99,  form_type_id: 3).first_or_create!
FormTypeQuestion.where(question_id: 100, form_type_id: 6).first_or_create!
FormTypeQuestion.where(question_id: 100, form_type_id: 1).first_or_create!
FormTypeQuestion.where(question_id: 100, form_type_id: 2).first_or_create!
FormTypeQuestion.where(question_id: 100, form_type_id: 5).first_or_create!
FormTypeQuestion.where(question_id: 100, form_type_id: 4).first_or_create!
FormTypeQuestion.where(question_id: 101, form_type_id: 2).first_or_create!
FormTypeQuestion.where(question_id: 102, form_type_id: 2).first_or_create!
FormTypeQuestion.where(question_id: 103, form_type_id: 2).first_or_create!
FormTypeQuestion.where(question_id: 104, form_type_id: 2).first_or_create!
FormTypeQuestion.where(question_id: 105, form_type_id: 6).first_or_create!
FormTypeQuestion.where(question_id: 105, form_type_id: 1).first_or_create!
FormTypeQuestion.where(question_id: 105, form_type_id: 2).first_or_create!
FormTypeQuestion.where(question_id: 105, form_type_id: 5).first_or_create!
FormTypeQuestion.where(question_id: 105, form_type_id: 4).first_or_create!
FormTypeQuestion.where(question_id: 106, form_type_id: 6).first_or_create!
FormTypeQuestion.where(question_id: 106, form_type_id: 1).first_or_create!
FormTypeQuestion.where(question_id: 106, form_type_id: 5).first_or_create!
FormTypeQuestion.where(question_id: 106, form_type_id: 4).first_or_create!
FormTypeQuestion.where(question_id: 107, form_type_id: 2).first_or_create!
FormTypeQuestion.where(question_id: 108, form_type_id: 6).first_or_create!
FormTypeQuestion.where(question_id: 108, form_type_id: 1).first_or_create!
FormTypeQuestion.where(question_id: 108, form_type_id: 2).first_or_create!
FormTypeQuestion.where(question_id: 108, form_type_id: 5).first_or_create!
FormTypeQuestion.where(question_id: 108, form_type_id: 4).first_or_create!
FormTypeQuestion.where(question_id: 110, form_type_id: 6).first_or_create!
FormTypeQuestion.where(question_id: 110, form_type_id: 1).first_or_create!
FormTypeQuestion.where(question_id: 110, form_type_id: 2).first_or_create!
FormTypeQuestion.where(question_id: 110, form_type_id: 3).first_or_create!
FormTypeQuestion.where(question_id: 110, form_type_id: 4).first_or_create!
FormTypeQuestion.where(question_id: 110, form_type_id: 5).first_or_create!
FormTypeQuestion.where(question_id: 111, form_type_id: 6).first_or_create!
FormTypeQuestion.where(question_id: 111, form_type_id: 1).first_or_create!
FormTypeQuestion.where(question_id: 111, form_type_id: 2).first_or_create!
FormTypeQuestion.where(question_id: 111, form_type_id: 5).first_or_create!
FormTypeQuestion.where(question_id: 111, form_type_id: 4).first_or_create!
FormTypeQuestion.where(question_id: 112, form_type_id: 6).first_or_create!
FormTypeQuestion.where(question_id: 112, form_type_id: 1).first_or_create!
FormTypeQuestion.where(question_id: 112, form_type_id: 2).first_or_create!
FormTypeQuestion.where(question_id: 112, form_type_id: 5).first_or_create!
FormTypeQuestion.where(question_id: 112, form_type_id: 4).first_or_create!
FormTypeQuestion.where(question_id: 113, form_type_id: 6).first_or_create!
FormTypeQuestion.where(question_id: 113, form_type_id: 1).first_or_create!
FormTypeQuestion.where(question_id: 113, form_type_id: 2).first_or_create!
FormTypeQuestion.where(question_id: 113, form_type_id: 5).first_or_create!
FormTypeQuestion.where(question_id: 113, form_type_id: 4).first_or_create!
FormTypeQuestion.where(question_id: 114, form_type_id: 6).first_or_create!
FormTypeQuestion.where(question_id: 114, form_type_id: 1).first_or_create!
FormTypeQuestion.where(question_id: 114, form_type_id: 2).first_or_create!
FormTypeQuestion.where(question_id: 114, form_type_id: 5).first_or_create!
FormTypeQuestion.where(question_id: 114, form_type_id: 4).first_or_create!
FormTypeQuestion.where(question_id: 115, form_type_id: 6).first_or_create!
FormTypeQuestion.where(question_id: 115, form_type_id: 1).first_or_create!
FormTypeQuestion.where(question_id: 115, form_type_id: 2).first_or_create!
FormTypeQuestion.where(question_id: 115, form_type_id: 5).first_or_create!
FormTypeQuestion.where(question_id: 116, form_type_id: 6).first_or_create!
FormTypeQuestion.where(question_id: 116, form_type_id: 1).first_or_create!
FormTypeQuestion.where(question_id: 116, form_type_id: 2).first_or_create!
FormTypeQuestion.where(question_id: 116, form_type_id: 5).first_or_create!
FormTypeQuestion.where(question_id: 116, form_type_id: 4).first_or_create!
FormTypeQuestion.where(question_id: 117, form_type_id: 1).first_or_create!
FormTypeQuestion.where(question_id: 117, form_type_id: 5).first_or_create!
FormTypeQuestion.where(question_id: 117, form_type_id: 4).first_or_create!
FormTypeQuestion.where(question_id: 118, form_type_id: 5).first_or_create!
FormTypeQuestion.where(question_id: 118, form_type_id: 4).first_or_create!
FormTypeQuestion.where(question_id: 119, form_type_id: 2).first_or_create!
FormTypeQuestion.where(question_id: 120, form_type_id: 1).first_or_create!
FormTypeQuestion.where(question_id: 121, form_type_id: 2).first_or_create!
FormTypeQuestion.where(question_id: 122, form_type_id: 2).first_or_create!
FormTypeQuestion.where(question_id: 123, form_type_id: 2).first_or_create!
